...
namespace DOL.GS
{
	...
	public class NpcTemplate : INpcTemplate
	{
		...
		public NpcTemplate( GameNPC mob )
		{
			...
			m_charisma = mob.Attributes.GetPropertyBase(eProperty.Charisma);
			m_classType = mob.GetType().ToString();
			m_constitution = mob.Attributes.GetPropertyBase(eProperty.Constitution);
            m_dexterity = mob.Attributes.GetPropertyBase(eProperty.Dexterity);
            m_empathy = mob.Attributes.GetPropertyBase(eProperty.Empathy);
			...
			m_intelligence = mob.Attributes.GetPropertyBase(eProperty.Intelligence);
			...
			m_piety = mob.Attributes.GetPropertyBase(eProperty.Piety);
			m_quickness = mob.Attributes.GetPropertyBase(eProperty.Quickness);
			m_strength = mob.Attributes.GetPropertyBase(eProperty.Strength);
